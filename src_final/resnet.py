...
# Build model
def build_model(start_neurons, block="resnet", DropoutRatio = 0.5,filter_size=32, nClasses=2):
    # 101 -> 50
    input_length = 2000
...
if __name__ == '__main__':
    model_type = "resnet"
    model = build_model(block=model_type,start_neurons=16, DropoutRatio=0.5, filter_size=32, nClasses=3)
    print(model.summary())
